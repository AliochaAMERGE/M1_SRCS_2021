...
public class Util {
	...
	static {
		...
		// allairports.add(new Airport("ICN", "Seoul Incheon", "Seoul", "Incheon,Seoul",
		// "South Korea"));
		// allairports.add(new Airport("FRA", "Frankfurt", "Frankfurt",
		// "Frankfurt,Hesse", "Germany"));
		// allairports.add(new Airport("DEN", "Denver", "Denver", "Colorado", "United
		// States"));
		// allairports.add(new Airport("DEL", "Indira Gandhi", "Delhi", "Delhi",
		// "India"));
		// allairports.add(new Airport("SIN", "Singapore Changi", "Singapore",
		// "Changi,East Region", "Singapore"));
		// allairports.add(new Airport("BKK", "Suvarnabhumi", "Bang Phli", "Samut
		// Prakan", "Thailand"));
		// allairports.add(new Airport("JFK", "John F. Kennedy", "New York", "Queens,New
		// York", "United States"));
		// allairports.add(new Airport("MAD", "Madrid Barajas", "Madrid",
		// "Barajas,Madrid", "Spain"));
		// allairports.add(new Airport("SFO", "San Francisco", "San Francisco", "San
		// Mateo County,California", "United States"));
		// allairports.add(new Airport("BCN", "Barcelona–El Prat", "Barcelona",
		// "Barcelona", "Spain"));
		// allairports.add(new Airport("IST", "Istanbul", "Istanbul",
		// "Arnavutköy,Istanbul", "Turkey"));
		// allairports.add(new Airport("SEA", "Seattle–Tacoma", "Seattle", "Washington",
		// "United States"));
		// allairports.add(new Airport("LAS", "McCarran", "Las Vegas", "Nevada", "United
		// States"));
		// allairports.add(new Airport("MCO", "Orlando", "Orlando", "Florida", "United
		// States"));

		// allairports.add(new Airport("MEX", "Benito Juárez", "Mexico city",
		// "Venustiano Carranza", "Mexico"));
		// allairports.add(new Airport("SVO", "Sheremetyevo", "Moscow", "Khimki,Oblast",
		// "Russia"));
		// allairports.add(new Airport("TPE", "Taiwan Taoyuan", "Taipei",
		// "Dayuan,Taoyuan", "Taiwan"));
		// allairports.add(new Airport("MUC", "Munich", "Munich", "Freising,Bavaria",
		// "Germany"));
		// allairports.add(new Airport("MNL", "Ninoy Aquino", "Manila",
		// "Pasay/Parañaque,Metro Manila", "Philippines"));

		cities = allairports.stream().map(a -> a.getCity()).collect(Collectors.toList());

		// on divise les capacités par 10 par rapport à la réalité pour réduire la
		// latence des tests
