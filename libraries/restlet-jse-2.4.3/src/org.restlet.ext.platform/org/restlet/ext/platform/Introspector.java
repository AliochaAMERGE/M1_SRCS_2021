...
package org.restlet.ext.platform;
...
import org.restlet.ext.platform.internal.conversion.swagger.v1_2.SwaggerUtils;
import org.restlet.ext.platform.internal.introspection.application.ApplicationIntrospector;
import org.restlet.ext.platform.internal.introspection.application.ComponentIntrospector;
...
public class Introspector {
    ...
    public static void process(String[] args) throws TranslationException {
        ...
        String ulogin = null;
        String upwd = null;
        String serviceUrl = "https://cloud.restlet.com/";
    ...
    private static void printHelp() {
        ...
        cli.print();
        cli.print0("SYNOPSIS");
        cli.print1("org.restlet.ext.platform.Introspector [credentials] [actions] [options] [--language swagger SWAGGER_DEFINITION_URL_OR_PATH | APPLICATION]");

        cli.print();
        cli.print0("DESCRIPTION");
        cli.print1(
                "Publish to the Restlet Cloud platform the description of your Web API, represented by APPLICATION, the full name of your Restlet or JAX-RS application class or by the Swagger definition available at URL/PATH",
        ...
        cli.print12(
                "-i, --id cellId",
                "The identifier of an existing cell hosted by Restlet Cloud you want to update with this new documentation.",
        ...
        cli.print1(
                ...
                "'META-INF/services/org.restlet.ext.platform.internal.introspection.IntrospectionHelper' file",
